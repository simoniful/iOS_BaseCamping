...
struct Endpoint {
    ...
    static let attractionDetailCommonURL = "http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailCommon"
    // ?serviceKey=\(APIKey.attraction)&numOfRows=1&pageNo=1&MobileOS=IOS&MobileApp=BaseCamping&contentId=126508&defaultYN=Y&firstImageYN=Y&areacodeYN=N&catcodeYN=N&addrinfoYN=Y&mapinfoYN=N&overviewYN=Y
    static let attractionDetailIntroURL = "http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailIntro"
    // ?serviceKey=\(APIKey.attraction)&numOfRows=1&pageNo=1&MobileOS=IOS&MobileApp=BaseCamping&contentId=2674675&contentTypeId=15&_type=json
    static let attractionDetailPlusURL = "http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailInfo"
    // ?serviceKey=\(APIKey.attraction)&numOfRows=10&pageNo=1&MobileOS=IOS&MobileApp=BaseCamping&contentId=2674675&contentTypeId=15&_type=json
    static let attractionImagesURL = "http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailImage"
    // ?serviceKey=\(APIKey.attraction)&numOfRows=10&pageNo=1&MobileOS=IOS&MobileApp=BaseCamping&contentId=1095732&imageYN=Y&subImageYN=Y&_type=json
}
