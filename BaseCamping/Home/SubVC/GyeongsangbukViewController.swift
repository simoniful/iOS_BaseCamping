//
//  GyeongsangbukViewController.swift
//  BaseCamping
//
...
class GyeongsangbukViewController: UIViewController {
    ...
    @objc func fetchWeatherInfo() {
        let url = "\(Endpoint.weatherURL)?lat=\(String(describing: WeatherStation.locationDic["경상북도"]![0]))&lon=\(String(describing: WeatherStation.locationDic["경상북도"]![1]))&exclude=current,minutely,hourly,alerts&appid=\(APIKey.weather)&units=metric&lang=kr"
...
extension GyeongsangbukViewController: FSPagerViewDelegate,FSPagerViewDataSource {
...
extension GyeongsangbukViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
